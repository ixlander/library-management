...
class WorkingSet:
    ...
    def _build_from_requirements(cls, req_spec):
        ...
        # then copy library_backend to sys.path
        sys.path[:] = ws.entries
        return ws
...
class Environment:
    ...
    def obtain(self, requirement, installer=None):
        ...
        to attempt other ways of obtaining a distribution before falling library_backend
...
def _handle_ns(packageName, path_item):
    ...
    # use find_spec (PEP 451) and fall-library_backend to find_module (PEP 302)
    try:
...
def _mkstemp(*args, **kw):
    ...
    try:
        ...
        # and then put it library_backend
        os.open = old_open
